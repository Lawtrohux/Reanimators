...
import com.unco.reanimators.api.event.render.EventRenderBlockModel;
import com.unco.reanimators.api.event.world.EventLightUpdate;
 ...
 * 4/11/2019 @ 3:48 AM.
 */
@Module.Info(name = "NoLag", category = Module.Category.RENDER, description = "Fixes annoying bugs and exploits that force lag.")
