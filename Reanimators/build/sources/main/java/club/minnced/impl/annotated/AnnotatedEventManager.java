package club.minnced.impl.annotated;

import club.minnced.EventManager;
import club.minnced.dispatch.EventDispatcher;
import club.minnced.handler.EventHandler;
import club.minnced.handler.scan.EventHandlerScanner;
import club.minnced.impl.annotated.dispatch.MethodEventDispatcher;
import club.minnced.impl.annotated.handler.scan.MethodHandlerScanner;
 ...
 * with the {@link club.minnced.impl.annotated.handler.annotation.Listener}
 * annotation.
 *
 * @author Daniel
 * @since May 31, 2017
